...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rbOutcome = QtWidgets.QRadioButton(self.pageAdd)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rbOutcome.sizePolicy().hasHeightForWidth())
        self.rbOutcome.setSizePolicy(sizePolicy)
        self.rbOutcome.setChecked(True)
        self.rbOutcome.setObjectName("rbOutcome")
        self.buttonGroup = QtWidgets.QButtonGroup(MainWindow)
        self.buttonGroup.setObjectName("buttonGroup")
        self.buttonGroup.addButton(self.rbOutcome)
        self.modeLayout.addWidget(self.rbOutcome)
        ...
        self.btnLocation = QtWidgets.QPushButton(self.pageAdd)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout.addWidget(self.btnLocation, 6, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rbOutcome.setText(_translate("MainWindow", "- (outcome)"))
        self.rbIncome.setText(_translate("MainWindow", "+ (income)"))
        self.btnLocation.setText(_translate("MainWindow", "City, Country"))
